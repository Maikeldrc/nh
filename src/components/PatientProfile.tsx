...
import { Patient, User, Consent, Device, BPReading, DocumentRecord, AuditLog } from '../types';
import { 
          ...
          <div className="text-xs space-y-3">
            ...
            {device ? (
              <div className="bg-slate-50/50 border border-slate-200 rounded-xl p-3 space-y-1.5">
                <p className="font-bold text-slate-800 text-xs">{l('Modelo Entregado', 'Delivered Model')}:</p>
                <p className="text-slate-600 font-bold">{device.brand} - {device.model}</p>
                <p className="text-[10px] text-slate-400 font-mono">S/N: {device.serialNumber} • Kit ID: {device.kitId}</p>

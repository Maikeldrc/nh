...
export const translations = {
  ES: {
    ...
    admin: "Administrador",
    nurse: "Enfermera",
    auxiliary_personnel: "Personal Auxiliar — Operaciones de Enrollment",
    physician: "Médico",
    viewer: "Visualizador",
    auditor: "Auditor",
    ...
    step4_subtitle: "Asigne el monitor y registre el modelo y Device ID del dispositivo.",
  ...
  EN: {
    ...
    admin: "Administrator",
    nurse: "Nurse",
    auxiliary_personnel: "Auxiliary Personnel — Enrollment Operations",
    physician: "Physician",
    viewer: "Viewer",
    auditor: "Auditor",
    ...
    step4_subtitle: "Assign the monitor and record the device model and Device ID.",

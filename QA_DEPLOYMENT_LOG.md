...
- Corrections: Added Playwright production config and smoke tests; removed external Google Fonts import; added accessible names to dashboard selects; allowed exact Firebase Google API script origin in CSP.
...
- Production validation: desktop smoke passed after first frontend deploy; mobile failed on QA-DEF-004 and secure-service-unavailable after CSP block
- Regression: pending
